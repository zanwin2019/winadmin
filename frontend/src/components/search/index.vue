<template>
	<div class="table-search-container" v-if="props.search.length > 0">
		<el-form ref="tableSearchRef" :model="state.form" size="default" label-width="80px" class="table-form">
			<el-row>
				<el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6" class="mb20" v-for="(val, key) in search" :key="key" v-show="key < 3 || state.isToggle">
					<template v-if="val.type !== ''">
						...
						>
							<el-input v-model="state.form[val.prop]" :placeholder="val.placeholder" clearable v-if="val.type === 'input'" style="width: 250px" />
							<el-date-picker
							...
							<el-date-picker
								...
								style="width: 250px"
							/>
							<el-select v-model="state.form[val.prop]" :placeholder="val.placeholder" v-else-if="val.type === 'select'" style="width: 250px">
				...
				<el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="4" class="mb20">
					<el-form-item class="table-form-btn" :label-width="search.length < 3 ? '20px' : '100px'">
						...
						<div style="display: flex;">
							...
							<!-- <el-button v-if="config.isadd" size="default" type="success" class="ml10" @click="onOpenAddDic('tableSearchRef')">
								<el-icon>
									<ele-FolderAdd />
								</el-icon>
								{{config.title}}
