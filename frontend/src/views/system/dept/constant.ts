...
export const tableData = {
	...
	header: [
		...
		{ key: 'name', colWidth: '100', align:'center', title: '岗位名称', type: 'text', isCheck: true },
		{ key: 'chname', colWidth: '120', align:'center', title: '部门负责人', type: 'text', isCheck: true },
		...
		{ key: 'desc', colWidth: '', align:'center', title: '描述', type: 'text', isCheck: true },
		{ key: 'operate', colWidth: '180', align:'center', title: '操作', type: 'text', isCheck: true,slot:'operateSlot', fixed:'right' },
	],
	// 配置项（必传）
	config: {
		total: 0, // 列表总数
...
export const searchData = {
	...
	search: [
		{ label: '部门名称', prop: 'name', placeholder: '请输入岗位名称',required:false, type: 'input' },
	],
};
